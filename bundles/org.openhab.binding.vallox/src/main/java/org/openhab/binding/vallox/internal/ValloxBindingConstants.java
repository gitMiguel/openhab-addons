...
/**
 * The {@link ValloxBindingConstants} class defines common constants, which are
...
public class ValloxBindingConstants {
    ...
    public static final ThingTypeUID THING_TYPE_VALLOX_IP = new ThingTypeUID(BINDING_ID, "se-tcp");
    public static final ThingTypeUID THING_TYPE_VALLOX_SERIAL = new ThingTypeUID(BINDING_ID, "se-serial");

    // Poll byte
    public static final byte POLL_BYTE = 0x00;
    ...
    public static final int SERIAL_PORT_READ_TIMEOUT = 15 * 1000;
    ...
    // List that holds byte addresses for control panels 1-8
    public static final byte ADDRESS_PANEL_MAPPING[] = { 0x21, 0x22, 0x23, 0x24, 0x25, 0x26, 0x27, 0x28 };

    // List that holds byte addresses for fan speeds 1-8
